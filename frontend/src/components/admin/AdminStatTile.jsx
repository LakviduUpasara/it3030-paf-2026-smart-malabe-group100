function AdminStatTile({ label, value, detail, icon: Icon }) {
  return (
    <article className="relative overflow-hidden rounded-3xl border border-border bg-card p-5 shadow-shadow">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          ...
          {detail ? <p className="mt-1 text-sm text-text/70">{detail}</p> : null}
        </div>
        {Icon ? (
