...
public class CatalogModuleController {
    ...
    public List<CatalogModuleResponse> applicable(
            @RequestParam String facultyCode, @RequestParam String degreeId, @RequestParam String term) {
        return catalogModuleService.listApplicable(facultyCode, degreeId, term);
    }
